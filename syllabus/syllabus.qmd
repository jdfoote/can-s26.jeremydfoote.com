...
**Office Hours:** BRNG 2134; Tuesdays and Thursdays; 10:00–11:00 am and by appointment
...
* Textbooks (readings are linked from the schedule):
...
LLMs like Claude.AI, Gemini, or ChatGPT can also be helpful in summarizing and extracting key points from these articles, but I expect you to engage with the material critically and not rely solely on AI for understanding.
...
On the bottom of each week's schedule is an embedded poll, where you should submit your discussion question. You should also vote on at least a few other questions that you think would be interesting to discuss. We will talk about the top few in class.
...
Students will complete a [Final Project](/assignments/final_project/Final-project.qmd) that uses the theories, principles, and skills learned in this class.
...
Academic integrity also applies to AI. I am a technology optimist, and an AI optimist. I think AI can be an amazing tool for education and learning, but it can also be misused. I expect you to use AI responsibly. Specifically:

- You write your own work.
- You can use AI to help understand topics and readings. Indeed, I hope you do.
- You can use AI to understand how to fix programming bugs, but don't ask it to write your code for you.
- You can use AI to brainstorm ideas or get feedback on your work, but not for writing your assignments.
